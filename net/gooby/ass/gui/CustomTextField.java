...
public class CustomTextField extends Gui
{
    ...
    private int enabledColor = 0xFF00ECFF;
    ...
    public CustomTextField(int p_i45542_1_, FontRenderer p_i45542_2_, int p_i45542_3_, int p_i45542_4_, int p_i45542_5_, int p_i45542_6_)
    {
