  ...
  extends Gui
{
  ...
  public GuiPasswordField(int p_i45542_1_, FontRenderer p_i45542_2_, String placeHolder, int p_i45542_3_, int p_i45542_4_, int p_i45542_5_, int p_i45542_6_)
  {
  ...
  public void drawTextBox()
  {
    if (getVisible())
    {
      ...
      {
        drawRect(this.xPosition - 1, this.yPosition - 1, this.xPosition + this.width + 1, this.yPosition + this.height + 1, 0x90990000);
      ...
      if ((var4.length() < 1) && (this.placeHolder.length() > 0)) {
        this.fontRendererInstance.drawString(this.placeHolder, var7, var8, -8750470);
      }
      if (var4.length() > 0)
      {
